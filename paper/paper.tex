...
\caption{Correlation of antibody binding scores from the escape calculator with experimentally measured fold changes in neutralization IC50 values for SARS-CoV-2 variants and mutants.
